...
public class BasePage {
    ...
    // Constructor que obtiene el WebDriver desde DriverManager
    public BasePage() {
        this.driver = DriverManager.getDriver();  // Aquí obtiene el driver ya configurado
    ...
    public void cambiarVentana(int pantalla){ // numero de ventanas ordenadas en un array
        try {
